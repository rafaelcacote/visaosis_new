    ...
    public function patientHistoryFull(Request $request, $id)
    {
        ...
        $history = $consultations->map(function ($consulta) {
            ...
            return [
                ...
                'od_esferico_perto' => optional($pres)->esfera_od_perto,
                'oe_esferico_perto' => optional($pres)->esfera_oe_perto,
                'od_cilindrico_perto' => optional($pres)->cilindro_od_perto,
                'oe_cilindrico_perto' => optional($pres)->cilindro_oe_perto,
                'od_eixo_perto' => optional($pres)->eixo_od_perto,
                'oe_eixo_perto' => optional($pres)->eixo_oe_perto,
                'od_acuidade_perto' => optional($pres)->acuidade_od_perto,
                'oe_acuidade_perto' => optional($pres)->acuidade_oe_perto,
                'od_adicao_perto' => optional($pres)->adicao_od_perto,
                'oe_adicao_perto' => optional($pres)->adicao_oe_perto,
                'od_dnp_perto' => optional($pres)->dnp_od_perto,
                'oe_dnp_perto' => optional($pres)->dnp_oe_perto,
                'od_altura_perto' => optional($pres)->altura_od_perto,
                'oe_altura_perto' => optional($pres)->altura_oe_perto,
