                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       id="preco_custo"
                                       name="preco_custo"
                                       value="{{ old('preco_custo', $produto->preco_custo) ? 'R$ ' . number_format(old('preco_custo', $produto->preco_custo), 2, ',', '.') : '' }}"
                                       placeholder="R$ 0,00"
                                       data-mask="currency">
                                @error('preco_custo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       id="preco_venda"
                                       name="preco_venda"
                                       value="{{ old('preco_venda', $produto->preco_venda) ? 'R$ ' . number_format(old('preco_venda', $produto->preco_venda), 2, ',', '.') : '' }}"
                                       placeholder="R$ 0,00"
                                       data-mask="currency"
                                       required>
                                @error('preco_venda')
