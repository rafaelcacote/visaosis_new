                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="nome_mae"
                                    name="nome_mae"
                                    value="{{ old('nome_mae', $pessoa->nome_mae) }}"
                                >
                                @error('nome_mae')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="nome_pai"
                                    name="nome_pai"
                                    value="{{ old('nome_pai', $pessoa->nome_pai) }}"
                                >
                                @error('nome_pai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option value="1" {{ old('sexo', $pessoa->sexo) == '1' ? 'selected' : '' }}>Masculino</option>
                                    <option value="2" {{ old('sexo', $pessoa->sexo) == '2' ? 'selected' : '' }}>Feminino</option>
                                </select>
                                @error('sexo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input
                                        ...
                                        id="cep"
                                        name="cep"
                                        value="{{ old('cep', $pessoa->cep_formatado) }}"
