...
<div class="d-xl-flex justify-content-between align-items-start mb-4">
    <div>
        <h2 class="text-dark font-weight-bold mb-2">
            <i class="mdi mdi-flask-plus me-2"></i>
            Novo Laboratório
        </h2>
        <p class="text-muted mb-0">Cadastrar um novo laboratório no sistema</p>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('laboratorios.store') }}" method="POST" id="laboratorioForm">
                    @csrf
