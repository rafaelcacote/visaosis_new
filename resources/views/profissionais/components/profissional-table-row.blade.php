<tr>
    <td class="list-actions-col-descricao">
        <div class="d-flex align-items-center">
            ...
            <div class="list-actions-desc-text">
                ...
                @endif
                <small
                    class="text-muted d-md-none d-block">{{ $profissional->especialidade->descricao ?? 'Não informado' }}</small>
            </div>
        </div>
    </td>
    ...
    <td class="list-actions-col-acoes">
        <div class="actions list-actions-buttons">
            <a href="{{ route('profissionais.show', $profissional->id) }}" class="btn-action btn-action-view"
                title="Visualizar">
                <i class="mdi mdi-eye"></i>
            </a>
            <a href="{{ route('profissionais.edit', $profissional->id) }}" class="btn-action btn-action-edit"
                title="Editar">
                <i class="mdi mdi-pencil"></i>
            </a>
            <button type="button"
                class="btn-action d-none d-md-inline-flex {{ $profissional->ativo ? 'btn-action-status-desativar' : 'btn-action-status-ativar' }}"
                title="{{ $profissional->ativo ? 'Desativar' : 'Ativar' }}" data-toggle-status
            ...
            <button type="button" class="btn-action btn-action-delete" title="Excluir" data-bs-toggle="modal"
                data-bs-target="#deleteModal" data-profissional-id="{{ $profissional->id }}"
                data-profissional-nome="{{ $profissional->nome }}">
