    ...
    <div class="row">
        <div class="col-12">
            ...
            <form id="triageForm" action="{{ route('attendance.triage.store') }}" method="POST">
                ...
                <div class="card mb-4" id="triageInfo"
                    style="display: {{ $errors->any() || old('nome') || old('apelido') || old('cpf') || old('profissional_id') || old('tipo') || old('prioridade') ? 'block' : 'none' }};">
                    <div class="card-header">
                        <h5 class="mb-0">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center px-4 pb-4">
                    ...
                    <p class="text-muted mt-2 mb-0" style="font-size: 0.875rem;">Os dados inseridos serão perdidos e não
                        poderão ser recuperados.</p>
                </div>
