<tr>
    <td class="list-actions-col-descricao">
        <div class="d-flex align-items-center">
            <div class="   d-none d-md-inline-flex bg-primary text-white rounded-circle d-inline-flex align-items-center justify-content-center me-3"
    ...
    <td class="list-actions-col-acoes">
        <div class="actions list-actions-buttons">
            <a href="{{ route('especialidades.show', $especialidade->id) }}" class="btn-action btn-action-view"
                title="Visualizar">
                <i class="mdi mdi-eye"></i>
            </a>
            <a href="{{ route('especialidades.edit', $especialidade->id) }}" class="btn-action btn-action-edit"
                title="Editar">
                <i class="mdi mdi-pencil"></i>
            </a>
            <button type="button" class="btn-action btn-action-delete" title="Excluir" data-bs-toggle="modal"
                data-bs-target="#deleteModal" data-especialidade-id="{{ $especialidade->id }}"
